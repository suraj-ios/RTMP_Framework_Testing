...
class ViewController: UIViewController {
    ...
    var streamKey_FaceBook = "FB-284845230113884-0-AbwARWzTK7bXayCl"
    ...
    override func viewDidLoad() {
        ...
        self.serverUrl = self.serverUrl_FaceBook
        self.streamKey = self.streamKey_FaceBook
    ...
    var isScreenCaptureEnable:Bool = false
    ...
    func NotScreenCaptureSession(){
        ...
        self.isScreenCaptureEnable = false
    ...
    func screenCaptureSessionFunc(){
        ...
        self.isScreenCaptureEnable = true
    ...
    @objc
        ...
        case RTMPConnection.Code.connectSuccess.rawValue:
            ...
            if(self.isScreenCaptureEnable == false){
